        ...
        <header className="sticky top-0 z-30 border-b border-line bg-paper/85 backdrop-blur-sm">
          <div className="mx-auto flex max-w-[1080px] items-center justify-between gap-4 px-6 py-4 sm:px-9 lg:px-12">
            ...
            >
              ...
              <span className="hidden text-[11px] font-semibold uppercase tracking-[0.18em] text-ink-faint sm:inline">
                {profile.title}
              </span>
            </Link>
            ...
            <Link
              href={backHref}
              className="no-print group -mr-2 inline-flex min-h-9 items-center gap-1.5 rounded-lg px-2 py-1.5 text-[13px] font-medium text-ink-muted transition-colors duration-200 hover:bg-paper-3 hover:text-ink"
            >
              <ArrowLeftIcon
                width={15}
                height={15}
