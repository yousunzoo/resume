...
export const aboutMe: string[] = [
  "누적 사용자 800만 명 규모 금융 플랫폼의 프론트엔드를 3년간 개발·운영한 개발자입니다. 신청 이탈률 80% 감소, 운영 오류 접수율 90% 감소처럼 사용자와 운영에 직접 닿는 지표를 구조 개선으로 만들어 왔고, 공통 패키지·Start-kit·AI 기반 개발 프로세스를 구축해 팀의 반복 작업과 변경 비용을 줄이는 일까지 담당했습니다. 기획·디자인·백엔드와 요구사항을 함께 정의하고 구현 범위를 조율하며, 다수의 SI 프로젝트를 요구사항 구체화부터 출시·운영까지 End-to-End로 완성했습니다.",
